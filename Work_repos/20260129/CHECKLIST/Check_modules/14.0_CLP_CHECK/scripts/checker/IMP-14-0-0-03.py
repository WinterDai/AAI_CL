################################################################################
# Script Name: IMP-14-0-0-03.py
#
# Purpose:
#   Confirm the CLP check result is clean.
#
# Logic:
...
class Check_14_0_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
