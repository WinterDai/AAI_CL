################################################################################
# Script Name: IMP-14-0-0-06.py
#
# Purpose:
#   Confirm you have run CLP without issue if the design has VDD_AO domain or other low power features like power gating, retention etc.
#
# Logic:
...
class Check_14_0_0_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
