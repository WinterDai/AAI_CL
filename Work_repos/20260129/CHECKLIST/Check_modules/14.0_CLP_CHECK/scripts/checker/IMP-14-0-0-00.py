################################################################################
# Script Name: IMP-14-0-0-00.py
#
# Purpose:
#   Confirm set the correct golden netlist.
#
# Logic:
...
class Check_14_0_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
