################################################################################
# Script Name: IMP-14-0-0-05.py
#
# Purpose:
#   Confirm all Warning message in CLP log files can be waived.
#
# Logic:
...
class Check_14_0_0_05(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
