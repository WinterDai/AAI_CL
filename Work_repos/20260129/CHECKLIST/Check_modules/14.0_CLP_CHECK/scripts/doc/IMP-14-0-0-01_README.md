...
**Check ID:** IMP-14-0-0-01  
**Description:** Confirm pass the formal check for final release netlist.  
...
item_desc = "Confirm pass the formal check for final release netlist."
...
python common/regression_testing/create_all_snapshots.py --modules 14.0_CLP_CHECK --checkers IMP-14-0-0-01 --force

# Run individual tests
python IMP-14-0-0-01.py
