...
**Check ID:** IMP-14-0-0-03  
**Description:** Confirm the CLP check result is clean.  
...
item_desc = "Confirm the CLP check result is clean."
...
python common/regression_testing/create_all_snapshots.py --modules 14.0_CLP_CHECK --checkers IMP-14-0-0-03 --force

# Run individual tests
python IMP-14-0-0-03.py
