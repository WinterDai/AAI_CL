...
python common/regression_testing/create_all_snapshots.py --modules 14.0_CLP_CHECK --checkers IMP-14-0-0-00 --force

# Run individual tests
python IMP-14-0-0-00.py
