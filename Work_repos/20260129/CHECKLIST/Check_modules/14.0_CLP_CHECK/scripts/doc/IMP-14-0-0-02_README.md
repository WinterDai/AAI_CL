...
**Check ID:** IMP-14-0-0-02  
**Description:** Confirm connect the PSO chain correctly. (Fill N/A if no PSO)  
...
python common/regression_testing/create_all_snapshots.py --modules 14.0_CLP_CHECK --checkers IMP-14-0-0-02 --force

# Run individual tests
python IMP-14-0-0-02.py
