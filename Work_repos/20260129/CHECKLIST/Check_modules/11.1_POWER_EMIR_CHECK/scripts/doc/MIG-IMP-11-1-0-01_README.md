...
**Check ID:** MIG-IMP-11-1-0-01  
**Description:** Confrim the MIMCAP PGV view is provided by AMS team for die model correctness. (for non-MIMCAP case, please fill N/A)  
...
python common/regression_testing/create_all_snapshots.py --modules 11.1_POWER_EMIR_CHECK --checkers MIG-IMP-11-1-0-01 --force

# Run individual tests
python MIG-IMP-11-1-0-01.py
