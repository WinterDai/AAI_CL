...
**Check ID:** MIG-IMP-11-1-1-02  
**Description:** [VCD-based Power Evaluation] Confirm final power evaluation checklist (DDR_PHY_IP_Performance_Analysis_Template_V1p2) and reports have been reviewed by Reviewer.  
...
python common/regression_testing/create_all_snapshots.py --modules 11.1_POWER_EMIR_CHECK --checkers MIG-IMP-11-1-1-02 --force

# Run individual tests
python MIG-IMP-11-1-1-02.py
