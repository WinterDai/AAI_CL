...
**Check ID:** MIG-IMP-11-1-0-00  
**Description:** Confirm enable the full delay line to check the PG weak points related to delay line in EMIR analysis.  
...
python common/regression_testing/create_all_snapshots.py --modules 11.1_POWER_EMIR_CHECK --checkers MIG-IMP-11-1-0-00 --force

# Run individual tests
python MIG-IMP-11-1-0-00.py
