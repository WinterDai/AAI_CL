################################################################################
# Script Name: MIG-IMP-11-1-1-01.py
#
# Purpose:
#   [VCD-based Power Evaluation] Confirm no ERROR message in power evaluation log files.
#
# Logic:
...
class Check_MIG_11_1_1_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-11-1-1-01",
            item_desc="[VCD-based Power Evaluation] Confirm no ERROR message in power evaluation log files."
        )
