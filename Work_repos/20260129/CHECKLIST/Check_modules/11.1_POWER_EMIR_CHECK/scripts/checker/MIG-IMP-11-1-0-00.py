################################################################################
# Script Name: MIG-IMP-11-1-0-00.py
#
# Purpose:
#   Confirm enable the full delay line to check the PG weak points related to delay line in EMIR analysis.
#
# Logic:
...
class Check_MIG_11_1_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-11-1-0-00",
            item_desc="Confirm enable the full delay line to check the PG weak points related to delay line in EMIR analysis."
        )
