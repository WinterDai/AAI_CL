################################################################################
# Script Name: MIG-IMP-11-1-0-01.py
#
# Purpose:
#   Confrim the MIMCAP PGV view is provided by AMS team for die model correctness. (for non-MIMCAP case, please fill N/A)
#
# Logic:
...
class Check_MIG_11_1_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-11-1-0-01",
            item_desc="Confrim the MIMCAP PGV view is provided by AMS team for die model correctness. (for non-MIMCAP case, please fill N/A)"
        )
