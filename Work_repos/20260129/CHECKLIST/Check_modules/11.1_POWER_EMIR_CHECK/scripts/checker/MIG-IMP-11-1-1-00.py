################################################################################
# Script Name: MIG-IMP-11-1-1-00.py
#
# Purpose:
#   [VCD based Power Evaluation] Confirm all Warning message in power evaluation log files can be waived.
#
# Logic:
...
class Check_MIG_11_1_1_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
