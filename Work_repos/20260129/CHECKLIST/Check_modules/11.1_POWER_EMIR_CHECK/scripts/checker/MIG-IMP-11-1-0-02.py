################################################################################
# Script Name: MIG-IMP-11-1-0-02.py
#
# Purpose:
#   Confirm run VDDR domain EMIR for projects with Regulator and double confirm the VDDR domain total capacitance with AMS team. (For non Regulator case,please fill N/A)
#
# Logic:
...
class Check_MIG_11_1_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="11.1_POWER_EMIR_CHECK",
            item_id="MIG-IMP-11-1-0-02",
            item_desc="Confirm run VDDR domain EMIR for projects with Regulator and double confirm the VDDR domain total capacitance with AMS team. (For non Regulator case,please fill N/A)"
        )
