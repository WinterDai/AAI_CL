...
**Check ID:** SRG-IMP-7-1-0-01  
**Description:** Are the initial checks at flat level of Functional and DFT modes are reviewed with respective stakeholders?  
...
python common/regression_testing/create_all_snapshots.py --modules 7.1_INNOVUS_DESIGN_IN_CHECK --checkers SRG-IMP-7-1-0-01 --force

# Run individual tests
python SRG-IMP-7-1-0-01.py
