################################################################################
# Script Name: SRG-IMP-7-1-0-01.py
#
# Purpose:
#   Are the initial checks at flat level of Functional and DFT modes are reviewed with respective stakeholders?
#
# Logic:
...
class Check_SRG_7_1_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-7-1-0-01",
            item_desc="Are the initial checks at flat level of Functional and DFT modes are reviewed with respective stakeholders?"
        )
