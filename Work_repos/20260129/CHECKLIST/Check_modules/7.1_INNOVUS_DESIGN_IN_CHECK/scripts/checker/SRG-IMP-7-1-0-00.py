################################################################################
# Script Name: SRG-IMP-7-1-0-00.py
#
# Purpose:
#   Are the initial checks at block level of Functional and DFT modes are reviewed with respective stakeholders?
#
# Logic:
...
class Check_SRG_7_1_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="7.1_INNOVUS_DESIGN_IN_CHECK",
            item_id="SRG-IMP-7-1-0-00",
            item_desc="Are the initial checks at block level of Functional and DFT modes are reviewed with respective stakeholders?"
        )
