################################################################################
# Script Name: IMP-17-0-0-02.py
#
# Purpose:
#   Does the area contain all relevant and required information? Netlist/gds/db/lef/libs/spef etc
#
# Logic:
...
class Check_17_0_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-17-0-0-02",
            item_desc="Does the area contain all relevant and required information? Netlist/gds/db/lef/libs/spef etc"
        )
