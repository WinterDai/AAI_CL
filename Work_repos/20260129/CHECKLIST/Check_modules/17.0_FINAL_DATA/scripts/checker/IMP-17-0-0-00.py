################################################################################
# Script Name: IMP-17-0-0-00.py
#
# Purpose:
#   Confirm data has been copied to final release area? Provide a directory location in the comments field.
#
# Logic:
...
class Check_17_0_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="17.0_FINAL_DATA",
            item_id="IMP-17-0-0-00",
            item_desc="Confirm data has been copied to final release area? Provide a directory location in the comments field."
        )
