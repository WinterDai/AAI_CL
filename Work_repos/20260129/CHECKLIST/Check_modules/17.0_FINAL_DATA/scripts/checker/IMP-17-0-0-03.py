################################################################################
# Script Name: IMP-17-0-0-03.py
#
# Purpose:
#   Have all irrelevant release areas been deleted?
#
# Logic:
...
class Check_17_0_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-17-0-0-03",
            item_desc="Have all irrelevant release areas been deleted?"
        )
