################################################################################
# Script Name: IMP-17-0-0-04.py
#
# Purpose:
#   Have checks been run on release data (checkIt etc)?
#
# Logic:
...
class Check_17_0_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-17-0-0-04",
            item_desc="Have checks been run on release data (checkIt etc)?"
        )
