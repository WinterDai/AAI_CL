################################################################################
# Script Name: IMP-17-0-0-01.py
#
# Purpose:
#   Is the ‘latest’ updated to point to the final release area?
#
# Logic:
...
class Check_17_0_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-17-0-0-01",
            item_desc="Is the ‘latest’ updated to point to the final release area?"
        )
