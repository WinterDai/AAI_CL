...
**Check ID:** IMP-17-0-0-01  
**Description:** Is the ‘latest’ updated to point to the final release area?  
...
python common/regression_testing/create_all_snapshots.py --modules 17.0_FINAL_DATA --checkers IMP-17-0-0-01 --force

# Run individual tests
python IMP-17-0-0-01.py
