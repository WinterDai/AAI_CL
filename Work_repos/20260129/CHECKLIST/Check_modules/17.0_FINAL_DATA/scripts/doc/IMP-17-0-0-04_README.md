...
**Check ID:** IMP-17-0-0-04  
**Description:** Have checks been run on release data (checkIt etc)?  
...
python common/regression_testing/create_all_snapshots.py --modules 17.0_FINAL_DATA --checkers IMP-17-0-0-04 --force

# Run individual tests
python IMP-17-0-0-04.py
