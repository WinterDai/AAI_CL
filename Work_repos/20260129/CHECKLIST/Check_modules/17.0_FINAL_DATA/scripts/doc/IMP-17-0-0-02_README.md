...
**Check ID:** IMP-17-0-0-02  
**Description:** Does the area contain all relevant and required information? Netlist/gds/db/lef/libs/spef etc  
...
python common/regression_testing/create_all_snapshots.py --modules 17.0_FINAL_DATA --checkers IMP-17-0-0-02 --force

# Run individual tests
python IMP-17-0-0-02.py
