...
**Check ID:** IMP-17-0-0-03  
**Description:** Have all irrelevant release areas been deleted?  
...
python common/regression_testing/create_all_snapshots.py --modules 17.0_FINAL_DATA --checkers IMP-17-0-0-03 --force

# Run individual tests
python IMP-17-0-0-03.py
