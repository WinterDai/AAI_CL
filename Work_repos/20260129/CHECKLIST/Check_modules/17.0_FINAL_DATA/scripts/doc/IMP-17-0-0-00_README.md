...
**Check ID:** IMP-17-0-0-00  
**Description:** Confirm data has been copied to final release area? Provide a directory location in the comments field.  
...
python common/regression_testing/create_all_snapshots.py --modules 17.0_FINAL_DATA --checkers IMP-17-0-0-00 --force

# Run individual tests
python IMP-17-0-0-00.py
