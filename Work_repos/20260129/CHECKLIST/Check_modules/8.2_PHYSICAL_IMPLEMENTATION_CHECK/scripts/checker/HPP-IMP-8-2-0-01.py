################################################################################
# Script Name: HPP-IMP-8-2-0-01.py
#
# Purpose:
#   Confirm area and density targets were met?
#
# Logic:
...
class Check_HPP_8_2_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
