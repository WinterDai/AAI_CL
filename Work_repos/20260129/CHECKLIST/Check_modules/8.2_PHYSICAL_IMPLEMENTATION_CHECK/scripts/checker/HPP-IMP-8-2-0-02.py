################################################################################
# Script Name: HPP-IMP-8-2-0-02.py
#
# Purpose:
#   Confirm power goals are met in all modes (Functional & DFT) and corners using an activity file representative of each mode generated by Gate Level Simulation (GLS) on post PNR netlist?
#
# Logic:
...
class Check_HPP_8_2_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
