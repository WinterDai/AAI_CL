################################################################################
# Script Name: HPP-IMP-8-2-0-03.py
#
# Purpose:
#   Were approved buffer and delay cells used for hold fixing? Provide buffer list used for hold fixing in comments field.
#
# Logic:
...
class Check_HPP_8_2_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
