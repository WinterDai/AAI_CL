################################################################################
# Script Name: HPP-IMP-8-2-0-04.py
#
# Purpose:
#   Confirm spare cells or GA fill cells were added and placed evenly across the layout?
#
# Logic:
...
class Check_HPP_8_2_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
