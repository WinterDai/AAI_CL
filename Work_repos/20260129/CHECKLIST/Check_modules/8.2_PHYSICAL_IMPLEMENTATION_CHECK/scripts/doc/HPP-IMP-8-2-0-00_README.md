...
**Check ID:** HPP-IMP-8-2-0-00  
**Description:** Confirm floorplan has been peer reviewed and agreed?  
...
item_desc = "Confirm floorplan has been peer reviewed and agreed?"
...
python common/regression_testing/create_all_snapshots.py --modules 8.2_PHYSICAL_IMPLEMENTATION_CHECK --checkers HPP-IMP-8-2-0-00 --force

# Run individual tests
python HPP-IMP-8-2-0-00.py
