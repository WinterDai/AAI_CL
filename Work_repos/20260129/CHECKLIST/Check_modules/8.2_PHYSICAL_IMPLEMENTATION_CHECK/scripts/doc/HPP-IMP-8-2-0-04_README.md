...
**Check ID:** HPP-IMP-8-2-0-04  
**Description:** Confirm spare cells or GA fill cells were added and placed evenly across the layout?  
...
item_desc = "Confirm spare cells or GA fill cells were added and placed evenly across the layout?"
...
python common/regression_testing/create_all_snapshots.py --modules 8.2_PHYSICAL_IMPLEMENTATION_CHECK --checkers HPP-IMP-8-2-0-04 --force

# Run individual tests
python HPP-IMP-8-2-0-04.py
