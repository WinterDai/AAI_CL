...
**Check ID:** HPP-IMP-8-2-0-01  
**Description:** Confirm area and density targets were met?  
...
item_desc = "Confirm area and density targets were met?"
...
python common/regression_testing/create_all_snapshots.py --modules 8.2_PHYSICAL_IMPLEMENTATION_CHECK --checkers HPP-IMP-8-2-0-01 --force

# Run individual tests
python HPP-IMP-8-2-0-01.py
