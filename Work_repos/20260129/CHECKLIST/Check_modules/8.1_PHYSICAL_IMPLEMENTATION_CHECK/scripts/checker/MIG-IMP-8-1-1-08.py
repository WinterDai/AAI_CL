################################################################################
# Script Name: MIG-IMP-8-1-1-08.py
#
# Purpose:
#   Confirm follow the "Gen* I/O VREF and ESD Insertion Rule" in implementation guide AND DDRIO datasheet for IO planning. Please sent the IO order to AMS team to review if you are not that sure. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_08(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-08",
            item_desc="Confirm follow the "Gen* I/O VREF and ESD Insertion Rule" in implementation guide AND DDRIO datasheet for IO planning. Please sent the IO order to AMS team to review if you are not that sure. (check the Note)"
        )
