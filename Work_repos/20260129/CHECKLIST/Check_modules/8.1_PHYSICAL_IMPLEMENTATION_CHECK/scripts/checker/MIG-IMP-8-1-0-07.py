################################################################################
# Script Name: MIG-IMP-8-1-0-07.py
#
# Purpose:
#   Confirm placed the mimic delay cell related paths (from delay line output to DL IE/IL pins) carefully. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_0_07(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-07",
            item_desc="Confirm placed the mimic delay cell related paths (from delay line output to DL IE/IL pins) carefully. (check the Note)"
        )
