################################################################################
# Script Name: MIG-IMP-8-1-1-00.py
#
# Purpose:
...
class Check_MIG_8_1_1_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
