################################################################################
# Script Name: MIG-IMP-8-1-0-08.py
#
# Purpose:
#   Confirm you use the same VT and cell type(clock cell) as that on read DQS path to balance read DQ/DQS skew. Treat DQ read path as clock path.
#
# Logic:
...
class Check_MIG_8_1_0_08(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
