################################################################################
# Script Name: MIG-IMP-8-1-1-30.py
#
# Purpose:
#   Confrim add VDDQ/VDD decaps for DDRIO in test chip tv_chip level(Follow same decap insertion guidance in PHY implementation guide).
#
# Logic:
...
class Check_MIG_8_1_1_30(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-30",
            item_desc="Confrim add VDDQ/VDD decaps for DDRIO in test chip tv_chip level(Follow same decap insertion guidance in PHY implementation guide)."
        )
