################################################################################
# Script Name: MIG-IMP-8-1-0-09.py
#
# Purpose:
#   Confirm the delay element design name and sub-module name are uniquified. Make sure there is not same module name for difference slices. For example, add "_ACS" and "_ACM" postfix to delay element design name and sub-module name for ACS and ACM block.
#
# Logic:
...
class Check_MIG_8_1_0_09(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
