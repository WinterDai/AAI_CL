################################################################################
# Script Name: MIG-IMP-8-1-0-13.py
#
# Purpose:
#   Confirm "is_macro_cell : true ;" is specified for regulator cells in regulator lib file and the regulator pin connection is correct.(NSLEEP_IN and other input pins are not tied to 0. Fille N/A if there is no Regulator in your design)
#
# Logic:
...
class Check_MIG_8_1_0_13(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
