################################################################################
# Script Name: MIG-IMP-8-1-1-04.py
#
# Purpose:
#   Confirm the VDDQX bumps are assigned correctly. Exactly follow the "Memory Type" collum information. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
