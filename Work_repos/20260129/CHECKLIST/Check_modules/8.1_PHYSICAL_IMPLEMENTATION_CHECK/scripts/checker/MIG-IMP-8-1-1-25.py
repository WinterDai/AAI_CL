################################################################################
# Script Name: MIG-IMP-8-1-1-25.py
#
# Purpose:
#   Confirm follow the datasheet and implementation guide of IP blocks(DDRIO/PLL/Noisegen/GPIO etc). (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_25(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-25",
            item_desc="Confirm follow the datasheet and implementation guide of IP blocks(DDRIO/PLL/Noisegen/GPIO etc). (check the Note)"
        )
