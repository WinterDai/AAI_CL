################################################################################
# Script Name: MIG-IMP-8-1-1-05.py
#
# Purpose:
#   Confirm assign VDDQ_AO for CKE/RST IO region if data retention "CKE/RST always on enabled" is specified in addendum. And place the CKE/RST domain IOs correctly. For DDR5 application,CS pad will be used to replace CKE and should be put into VDDQ_AO IO domain too. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_05(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
