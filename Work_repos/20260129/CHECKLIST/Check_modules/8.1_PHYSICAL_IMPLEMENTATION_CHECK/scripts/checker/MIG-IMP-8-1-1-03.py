################################################################################
# Script Name: MIG-IMP-8-1-1-03.py
#
# Purpose:
#   Confirm with IO designer whether the IO is Gen1 IO or Gen2 IO or Gen3 IO.(check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-03",
            item_desc="Confirm with IO designer whether the IO is Gen1 IO or Gen2 IO or Gen3 IO.(check the Note)"
        )
