################################################################################
# Script Name: MIG-IMP-8-1-1-09.py
#
# Purpose:
#   confirm place the DESKEW PLL to the slice notch between two adjacent dataslices for LPDDR5 design with 32 or more bits to make the path delay from deskew pll to DQ/DQS write path smaller (better system budget).
#
# Logic:
...
class Check_MIG_8_1_1_09(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
