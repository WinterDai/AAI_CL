################################################################################
# Script Name: MIG-IMP-8-1-2-00.py
#
# Purpose:
#   [BRCM special] Confirm use pin blockage def for pin assignment for BRCM projects (for non-BRCM projects, please fill N/A) The pin def information is in /projects/workbench/versions/BRCM/pin_blockage_def/BRCM_Pin_Placement_DEF_release_notes.pdf
#
# Logic:
...
class Check_MIG_8_1_2_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-2-00",
            item_desc="[BRCM special] Confirm use pin blockage def for pin assignment for BRCM projects (for non-BRCM projects, please fill N/A) The pin def information is in /projects/workbench/versions/BRCM/pin_blockage_def/BRCM_Pin_Placement_DEF_release_notes.pdf"
        )
