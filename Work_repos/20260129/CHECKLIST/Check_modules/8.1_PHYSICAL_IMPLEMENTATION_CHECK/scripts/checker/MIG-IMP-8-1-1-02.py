################################################################################
# Script Name: MIG-IMP-8-1-1-02.py
#
# Purpose:
#   Confirm NO special VDDCK bump for PAD memory clock domain IO,should share the VDD bump from other core logic.
#
# Logic:
...
class Check_MIG_8_1_1_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-02",
            item_desc="Confirm NO special VDDCK bump for PAD memory clock domain IO,should share the VDD bump from other core logic."
        )
