################################################################################
# Script Name: MIG-IMP-8-1-1-31.py
#
# Purpose:
#   Confirm data retention IO VDD_AO pin must be connected to always-on VDD (mark N/A only when data_retention pad doesn't exist)”
#
# Logic:
...
class Check_MIG_8_1_1_31(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-31",
            item_desc="Confirm data retention IO VDD_AO pin must be connected to always-on VDD (mark N/A only when data_retention pad doesn't exist)”"
        )
