################################################################################
# Script Name: MIG-IMP-8-1-1-20.py
#
# Purpose:
#   Confirm the Deskew PLL CKFB connecte to FOUTP directly without buffers. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_20(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-20",
            item_desc="Confirm the Deskew PLL CKFB connecte to FOUTP directly without buffers. (check the Note)"
        )
