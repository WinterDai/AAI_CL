################################################################################
# Script Name: MIG-IMP-8-1-1-17.py
#
# Purpose:
#   Confirm the PG connection of Deskew PLL is correct and the PG resistance meet the integration guide. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_17(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-17",
            item_desc="Confirm the PG connection of Deskew PLL is correct and the PG resistance meet the integration guide. (check the Note)"
        )
