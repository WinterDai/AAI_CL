################################################################################
# Script Name: MIG-IMP-8-1-0-15.py
#
# Purpose:
#   Confirm reorder VDD*GONE connection based on IO sequence unless it's took care by custom layout.
#
# Logic:
...
class Check_MIG_8_1_0_15(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
