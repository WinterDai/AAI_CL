################################################################################
# Script Name: MIG-IMP-8-1-1-28.py
#
# Purpose:
#   Confirm the scan pins are assigned to be interleaved for PHY_TOP delivery. (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_28(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-28",
            item_desc="Confirm the scan pins are assigned to be interleaved for PHY_TOP delivery. (check the Note)"
        )
