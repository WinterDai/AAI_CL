################################################################################
# Script Name: MIG-IMP-8-1-0-05.py
#
# Purpose:
#   Confirm place the cells from delayElement0 to DL of each delay line closely and don't touch the net/cell on these paths.
#
# Logic:
...
class Check_MIG_8_1_0_05(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-05",
            item_desc="Confirm place the cells from delayElement0 to DL of each delay line closely and don't touch the net/cell on these paths."
        )
