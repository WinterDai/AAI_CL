################################################################################
# Script Name: MIG-IMP-8-1-1-27.py
#
# Purpose:
#   Confirm meet the decap requirement in die model checklist. (Check the Notes)
#
# Logic:
...
class Check_MIG_8_1_1_27(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
