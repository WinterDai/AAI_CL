################################################################################
# Script Name: MIG-IMP-8-1-0-03.py
#
# Purpose:
#   Confirm max D4 loading can be drove by DA cell and place loading instance close to DA cell(check the Note)
#
# Logic:
...
class Check_MIG_8_1_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-03",
            item_desc="Confirm max D4 loading can be drove by DA cell and place loading instance close to DA cell(check the Note)"
        )
