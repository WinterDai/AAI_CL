################################################################################
# Script Name: MIG-IMP-8-1-0-11.py
#
# Purpose:
#   Confirm the XTC crosstalk connection is correct for the DDRIO has *XTC ports. (Check the Note)
#
# Logic:
...
class Check_MIG_8_1_0_11(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-11",
            item_desc="Confirm the XTC crosstalk connection is correct for the DDRIO has *XTC ports. (Check the Note)"
        )
