################################################################################
# Script Name: MIG-IMP-8-1-1-32.py
#
# Purpose:
#   Confirm I/O voltage signal "DR_VALUE_HV/DR_EN_HV/VDDGONE*_HV/TIE*_HV/ATB*_HV" does not connect to VDD voltage device.
#
# Logic:
...
class Check_MIG_8_1_1_32(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
