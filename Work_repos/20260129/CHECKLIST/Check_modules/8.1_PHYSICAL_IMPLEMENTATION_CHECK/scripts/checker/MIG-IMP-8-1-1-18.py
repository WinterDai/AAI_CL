################################################################################
# Script Name: MIG-IMP-8-1-1-18.py
#
# Purpose:
#   Confirm the correct bump naming rule VDDAPLL_* for high voltage pin VDDA of dual rail Deskew PLL (check the Note)
#
# Logic:
...
class Check_MIG_8_1_1_18(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-18",
            item_desc="Confirm the correct bump naming rule VDDAPLL_* for high voltage pin VDDA of dual rail Deskew PLL (check the Note)"
        )
