################################################################################
# Script Name: MIG-IMP-8-1-1-11.py
#
# Purpose:
#   Confirm the bump assignment is sync with and agreed with the client or internal package team. And make sure the bump map sent to customer is same as that in final database.
#
# Logic:
...
class Check_MIG_8_1_1_11(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
