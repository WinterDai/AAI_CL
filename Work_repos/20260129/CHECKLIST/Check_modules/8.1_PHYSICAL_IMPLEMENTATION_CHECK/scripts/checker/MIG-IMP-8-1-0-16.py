################################################################################
# Script Name: MIG-IMP-8-1-0-16.py
#
# Purpose:
#   Confirm all the 3 NAND cells of clock mux in both PHY_TOP and Slice level are placed closely (distance <= 10um) and there is NO buffer/inverters inserted between the nand0/nand1 and nand2.
#
# Logic:
...
class Check_MIG_8_1_0_16(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-16",
            item_desc="Confirm all the 3 NAND cells of clock mux in both PHY_TOP and Slice level are placed closely (distance <= 10um) and there is NO buffer/inverters inserted between the nand0/nand1 and nand2."
        )
