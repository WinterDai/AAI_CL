################################################################################
# Script Name: MIG-IMP-8-1-0-01.py
#
# Purpose:
#   Confirm all bit slice ports which connect to IO are assigned at the same side close to IO.
#
# Logic:
...
class Check_MIG_8_1_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-0-01",
            item_desc="Confirm all bit slice ports which connect to IO are assigned at the same side close to IO."
        )
