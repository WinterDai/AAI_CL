################################################################################
# Script Name: MIG-IMP-8-1-1-10.py
#
# Purpose:
...
class Check_MIG_8_1_1_10(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
