################################################################################
# Script Name: MIG-IMP-8-1-1-12.py
#
# Purpose:
#   Confirm reset_n_pad (cdns_ddr_se_r_txrx_h) IO VDD_AO pin must be connected to always-on VDD.
#
# Logic:
...
class Check_MIG_8_1_1_12(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="MIG-IMP-8-1-1-12",
            item_desc="Confirm reset_n_pad (cdns_ddr_se_r_txrx_h) IO VDD_AO pin must be connected to always-on VDD."
        )
