################################################################################
# Script Name: MIG-IMP-8-1-0-06.py
#
# Purpose:
#   Confirm NO analog module (such as DA) is put in the middle of manual added inverter pairs in DCD path improvement activities.
#
# Logic:
...
class Check_MIG_8_1_0_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
