...
**Check ID:** MIG-IMP-8-1-0-09  
**Description:** Confirm the delay element design name and sub-module name are uniquified. Make sure there is not same module name for difference slices. For example, add "_ACS" and "_ACM" postfix to delay element design name and sub-module name for ACS and ACM block.  
...
item_desc = "Confirm the delay element design name and sub-module name are uniquified. Make sure there is not same module name for difference slices. For example, add "_ACS" and "_ACM" postfix to delay element design name and sub-module name for ACS and ACM block."
...
python common/regression_testing/create_all_snapshots.py --modules 8.1_PHYSICAL_IMPLEMENTATION_CHECK --checkers MIG-IMP-8-1-0-09 --force

# Run individual tests
python MIG-IMP-8-1-0-09.py
