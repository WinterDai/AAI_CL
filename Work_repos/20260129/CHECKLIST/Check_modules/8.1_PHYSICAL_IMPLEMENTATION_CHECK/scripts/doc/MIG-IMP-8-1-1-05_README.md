...
**Check ID:** MIG-IMP-8-1-1-05  
**Description:** Confirm assign VDDQ_AO for CKE/RST IO region if data retention "CKE/RST always on enabled" is specified in addendum. And place the CKE/RST domain IOs correctly. For DDR5 application,CS pad will be used to replace CKE and should be put into VDDQ_AO IO domain too. (check the Note)  
...
item_desc = "Confirm assign VDDQ_AO for CKE/RST IO region if data retention "CKE/RST always on enabled" is specified in addendum. And place the CKE/RST domain IOs correctly. For DDR5 application,CS pad will be used to replace CKE and should be put into VDDQ_AO IO domain too. (check the Note)"
...
python common/regression_testing/create_all_snapshots.py --modules 8.1_PHYSICAL_IMPLEMENTATION_CHECK --checkers MIG-IMP-8-1-1-05 --force

# Run individual tests
python MIG-IMP-8-1-1-05.py
