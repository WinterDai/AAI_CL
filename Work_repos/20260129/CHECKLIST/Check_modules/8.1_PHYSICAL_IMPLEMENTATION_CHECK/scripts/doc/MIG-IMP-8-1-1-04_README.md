...
**Check ID:** MIG-IMP-8-1-1-04  
**Description:** Confirm the VDDQX bumps are assigned correctly. Exactly follow the "Memory Type" collum information. (check the Note)  
...
item_desc = "Confirm the VDDQX bumps are assigned correctly. Exactly follow the "Memory Type" collum information. (check the Note)"
...
python common/regression_testing/create_all_snapshots.py --modules 8.1_PHYSICAL_IMPLEMENTATION_CHECK --checkers MIG-IMP-8-1-1-04 --force

# Run individual tests
python MIG-IMP-8-1-1-04.py
