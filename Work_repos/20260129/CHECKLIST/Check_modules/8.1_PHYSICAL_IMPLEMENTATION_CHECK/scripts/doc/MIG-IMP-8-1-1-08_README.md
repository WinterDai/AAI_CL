...
**Check ID:** MIG-IMP-8-1-1-08  
**Description:** Confirm follow the "Gen* I/O VREF and ESD Insertion Rule" in implementation guide AND DDRIO datasheet for IO planning. Please sent the IO order to AMS team to review if you are not that sure. (check the Note)  
...
python common/regression_testing/create_all_snapshots.py --modules 8.1_PHYSICAL_IMPLEMENTATION_CHECK --checkers MIG-IMP-8-1-1-08 --force

# Run individual tests
python MIG-IMP-8-1-1-08.py
