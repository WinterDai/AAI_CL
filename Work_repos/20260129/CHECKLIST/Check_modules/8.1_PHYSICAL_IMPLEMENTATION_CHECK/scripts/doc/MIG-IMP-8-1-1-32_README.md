...
**Check ID:** MIG-IMP-8-1-1-32  
**Description:** Confirm I/O voltage signal "DR_VALUE_HV/DR_EN_HV/VDDGONE*_HV/TIE*_HV/ATB*_HV" does not connect to VDD voltage device.  
...
item_desc = "Confirm I/O voltage signal "DR_VALUE_HV/DR_EN_HV/VDDGONE*_HV/TIE*_HV/ATB*_HV" does not connect to VDD voltage device."
...
python common/regression_testing/create_all_snapshots.py --modules 8.1_PHYSICAL_IMPLEMENTATION_CHECK --checkers MIG-IMP-8-1-1-32 --force

# Run individual tests
python MIG-IMP-8-1-1-32.py
