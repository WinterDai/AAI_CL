...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-0-03 --force

# Run individual tests
python MIG-IMP-10-1-0-03.py
