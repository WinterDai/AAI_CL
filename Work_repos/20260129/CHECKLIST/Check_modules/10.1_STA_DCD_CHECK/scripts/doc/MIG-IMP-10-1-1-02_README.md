...
**Check ID:** MIG-IMP-10-1-1-02  
**Description:** [DCD check] Confirm with Kato-san if DCD results is not meet the target.  
...
item_desc = "[DCD check] Confirm with Kato-san if DCD results is not meet the target."
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-1-02 --force

# Run individual tests
python MIG-IMP-10-1-1-02.py
