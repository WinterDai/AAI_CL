...
**Check ID:** MIG-IMP-10-1-1-01  
**Description:** [DCD check] Confirm with Balbeer the DCD flow and results are valid.  
...
item_desc = "[DCD check] Confirm with Balbeer the DCD flow and results are valid."
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-1-01 --force

# Run individual tests
python MIG-IMP-10-1-1-01.py
