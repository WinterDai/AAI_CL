...
**Check ID:** MIG-IMP-10-1-0-01  
**Description:** Confirm there are no unintentional cells in VDDR domain and all cells in VDDR domain are updated to latest STA environment.  
...
item_desc = "Confirm there are no unintentional cells in VDDR domain and all cells in VDDR domain are updated to latest STA environment."
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-0-01 --force

# Run individual tests
python MIG-IMP-10-1-0-01.py
