...
**Check ID:** MIG-IMP-10-1-2-02  
**Description:** [ETMQA check] Please provide the ETMQA run dir in comment. （Fill N/A if customer will not run ETM based STA)  
...
item_desc = "[ETMQA check] Please provide the ETMQA run dir in comment. （Fill N/A if customer will not run ETM based STA)"
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-2-02 --force

# Run individual tests
python MIG-IMP-10-1-2-02.py
