...
**Check ID:** MIG-IMP-10-1-0-02  
**Description:** Confirm have provided DCD analysis team the DCD path to set DCD analysis environment in stable stage and provide final DCD paths 2 weeks before final delivery.  
...
item_desc = "Confirm have provided DCD analysis team the DCD path to set DCD analysis environment in stable stage and provide final DCD paths 2 weeks before final delivery."
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-0-02 --force

# Run individual tests
python MIG-IMP-10-1-0-02.py
