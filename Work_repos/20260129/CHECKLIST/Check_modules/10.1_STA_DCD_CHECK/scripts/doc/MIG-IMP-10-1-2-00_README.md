...
**Check ID:** MIG-IMP-10-1-2-00  
**Description:** [ETMQA check] Confirm this program will support ETM based timing signoff on customer side. (Fill N/A if it doesn't support ETM based timing signoff on customer side, check with design team or PM about the details)  
...
item_desc = "[ETMQA check] Confirm this program will support ETM based timing signoff on customer side. (Fill N/A if it doesn't support ETM based timing signoff on customer side, check with design team or PM about the details)"
...
python common/regression_testing/create_all_snapshots.py --modules 10.1_STA_DCD_CHECK --checkers MIG-IMP-10-1-2-00 --force

# Run individual tests
python MIG-IMP-10-1-2-00.py
