################################################################################
# Script Name: MIG-IMP-10-1-1-00.py
#
# Purpose:
#   [DCD check] Confirm the spice used for DCD run is lpe based spice netlist with RC information. Otherwise the DCD results are not accurate. (Check the Notes)
#
# Logic:
...
class Check_MIG_10_1_1_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
