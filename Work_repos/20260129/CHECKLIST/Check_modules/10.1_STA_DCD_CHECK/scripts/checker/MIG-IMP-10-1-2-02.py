################################################################################
# Script Name: MIG-IMP-10-1-2-02.py
#
# Purpose:
#   [ETMQA check] Please provide the ETMQA run dir in comment. （Fill N/A if customer will not run ETM based STA)
#
# Logic:
...
class Check_MIG_10_1_2_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
