################################################################################
# Script Name: MIG-IMP-10-1-1-02.py
#
# Purpose:
#   [DCD check] Confirm with Kato-san if DCD results is not meet the target.
#
# Logic:
...
class Check_MIG_10_1_1_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
