################################################################################
# Script Name: MIG-IMP-10-1-0-01.py
#
# Purpose:
#   Confirm there are no unintentional cells in VDDR domain and all cells in VDDR domain are updated to latest STA environment.
#
# Logic:
...
class Check_MIG_10_1_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
