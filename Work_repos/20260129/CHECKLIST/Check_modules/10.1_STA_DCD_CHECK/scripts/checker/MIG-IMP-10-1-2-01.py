################################################################################
# Script Name: MIG-IMP-10-1-2-01.py
#
# Purpose:
...
class Check_MIG_10_1_2_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
