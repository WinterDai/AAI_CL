...
**Check ID:** IMP-7-0-0-06  
**Description:** Confirm the preserve cell list of all modes(Func/DFT/etc) are added to don’t touch list if design have.  
...
item_desc = "Confirm the preserve cell list of all modes(Func/DFT/etc) are added to don’t touch list if design have."
...
python common/regression_testing/create_all_snapshots.py --modules 7.0_INNOVUS_DESIGN_IN_CHECK --checkers IMP-7-0-0-06 --force

# Run individual tests
python IMP-7-0-0-06.py
