...
**Check ID:** IMP-7-0-0-07  
**Description:** Confirm UPF/CPF is delivered for Low Power Checks.(Fill N/A if no UPF is needed)  
...
item_desc = "Confirm UPF/CPF is delivered for Low Power Checks.(Fill N/A if no UPF is needed)"
...
python common/regression_testing/create_all_snapshots.py --modules 7.0_INNOVUS_DESIGN_IN_CHECK --checkers IMP-7-0-0-07 --force

# Run individual tests
python IMP-7-0-0-07.py
