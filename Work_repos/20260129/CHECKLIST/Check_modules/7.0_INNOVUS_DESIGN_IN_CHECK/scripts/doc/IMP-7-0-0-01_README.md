...
**Check ID:** IMP-7-0-0-01  
**Description:** Confirm the netlist/constraint version is correct. For MIG program, list FEI release package name in comment.  
...
item_desc = "Confirm the netlist/constraint version is correct. For MIG program, list FEI release package name in comment."
...
python common/regression_testing/create_all_snapshots.py --modules 7.0_INNOVUS_DESIGN_IN_CHECK --checkers IMP-7-0-0-01 --force

# Run individual tests
python IMP-7-0-0-01.py
