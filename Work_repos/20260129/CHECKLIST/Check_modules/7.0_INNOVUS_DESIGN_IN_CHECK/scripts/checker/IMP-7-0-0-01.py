################################################################################
# Script Name: IMP-7-0-0-01.py
#
# Purpose:
#   Confirm the netlist/constraint version is correct. For MIG program, list FEI release package name in comment.
#
# Logic:
...
class Check_7_0_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
