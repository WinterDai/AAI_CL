################################################################################
# Script Name: IMP-7-0-0-06.py
#
# Purpose:
#   Confirm the preserve cell list of all modes(Func/DFT/etc) are added to don’t touch list if design have.
#
# Logic:
...
class Check_7_0_0_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
