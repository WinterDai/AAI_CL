################################################################################
# Script Name: IMP-12-0-0-00.py
#
# Purpose:
#   Confirm the GDS includes dummy METAL/OD/PO/COD.
#
# Logic:
...
class Check_12_0_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
