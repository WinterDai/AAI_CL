################################################################################
# Script Name: IMP-12-0-0-29.py
#
# Purpose:
#   Confirm all Warning message in ARC log files can be waived. (For BRCM project only, for others fill N/A)
#
# Logic:
...
class Check_12_0_0_29(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-12-0-0-29",
            item_desc="Confirm all Warning message in ARC log files can be waived. (For BRCM project only, for others fill N/A)"
        )
