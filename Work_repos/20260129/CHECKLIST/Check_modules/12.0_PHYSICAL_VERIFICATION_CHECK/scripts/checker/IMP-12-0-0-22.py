################################################################################
# Script Name: IMP-12-0-0-22.py
#
# Purpose:
#   Confirm all Warning message in PV log files can be waived.
#
# Logic:
...
class Check_12_0_0_22(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
