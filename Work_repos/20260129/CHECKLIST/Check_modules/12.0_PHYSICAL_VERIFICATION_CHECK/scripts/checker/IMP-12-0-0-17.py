################################################################################
# Script Name: IMP-12-0-0-17.py
#
# Purpose:
#   Confirm no soft-connect issue.
#
# Logic:
...
class Check_12_0_0_17(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
