################################################################################
# Script Name: IMP-12-0-0-15.py
#
# Purpose:
#   Confirm the LVS check result is match.
#
# Logic:
...
class Check_12_0_0_15(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
