################################################################################
# Script Name: IMP-12-0-0-19.py
#
# Purpose:
#   Confirm Analog power/gnd labels are correct.
#
# Logic:
...
class Check_12_0_0_19(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-12-0-0-19",
            item_desc="Confirm Analog power/gnd labels are correct."
        )
