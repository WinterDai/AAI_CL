################################################################################
# Script Name: IMP-12-0-0-18.py
#
# Purpose:
#   Confirm the ERC check result is clean.
#
# Logic:
...
class Check_12_0_0_18(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
