################################################################################
# Script Name: IMP-12-0-0-13.py
#
# Purpose:
#   Confirm the ANT check result is clean.
#
# Logic:
...
class Check_12_0_0_13(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
