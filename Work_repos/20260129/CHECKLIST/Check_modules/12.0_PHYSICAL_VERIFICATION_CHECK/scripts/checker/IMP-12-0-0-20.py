################################################################################
# Script Name: IMP-12-0-0-20.py
#
# Purpose:
#   Confirm no unknown black boxes are reported.
#
# Logic:
...
class Check_12_0_0_20(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
