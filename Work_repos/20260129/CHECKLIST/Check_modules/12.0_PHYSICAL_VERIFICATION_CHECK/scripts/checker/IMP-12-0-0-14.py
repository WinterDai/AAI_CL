################################################################################
# Script Name: IMP-12-0-0-14.py
#
# Purpose:
#   Confirm the MIM_ANT check result is clean. (Fill N/a if no MIMCAP inserted or no MIM related layers)
#
# Logic:
...
class Check_12_0_0_14(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
