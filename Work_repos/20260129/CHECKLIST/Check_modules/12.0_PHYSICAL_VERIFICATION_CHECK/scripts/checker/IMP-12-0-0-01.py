################################################################################
# Script Name: IMP-12-0-0-01.py
#
# Purpose:
#   Confirm mock tapeout GDS includes dummy METAL/OD/PO/COD.
#
# Logic:
...
class Check_12_0_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-12-0-0-01",
            item_desc="Confirm mock tapeout GDS includes dummy METAL/OD/PO/COD."
        )
