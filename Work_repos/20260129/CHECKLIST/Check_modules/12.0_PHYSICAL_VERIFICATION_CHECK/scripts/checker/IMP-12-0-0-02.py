################################################################################
# Script Name: IMP-12-0-0-02.py
#
# Purpose:
#   Confirm the GDS was generated properly and physical verification has been run on final block GDS.
#
# Logic:
...
class Check_12_0_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
