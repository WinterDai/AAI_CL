################################################################################
# Script Name: IMP-12-0-0-23.py
#
# Purpose:
#   Confirm set proper LVS bump text files (e.g: not include VDDG/VREF internal pin).
#
# Logic:
...
class Check_12_0_0_23(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
