################################################################################
# Script Name: IMP-12-0-0-16.py
#
# Purpose:
#   Confrim there is no issue for lvs.rep and extra pins in lvs.rep.cls even the results shows MATCH(check the Note)
#
# Logic:
...
class Check_12_0_0_16(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
