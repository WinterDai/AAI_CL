################################################################################
# Script Name: IMP-12-0-0-34.py
#
# Purpose:
#   Confirm all Warning message in RTO DRC log files can be waived. (for SEC process, for others fill N/A)
#
# Logic:
...
class Check_12_0_0_34(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-12-0-0-34",
            item_desc="Confirm all Warning message in RTO DRC log files can be waived. (for SEC process, for others fill N/A)"
        )
