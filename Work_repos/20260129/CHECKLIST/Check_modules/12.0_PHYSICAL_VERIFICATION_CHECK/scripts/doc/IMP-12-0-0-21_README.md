...
**Check ID:** IMP-12-0-0-21  
**Description:** Confirm no ERROR message in PV log files.  
...
item_desc = "Confirm no ERROR message in PV log files."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-21 --force

# Run individual tests
python IMP-12-0-0-21.py
