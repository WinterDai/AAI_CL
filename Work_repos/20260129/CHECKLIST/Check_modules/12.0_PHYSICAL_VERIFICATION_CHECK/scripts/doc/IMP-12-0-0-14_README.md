...
**Check ID:** IMP-12-0-0-14  
**Description:** Confirm the MIM_ANT check result is clean. (Fill N/a if no MIMCAP inserted or no MIM related layers)  
...
item_desc = "Confirm the MIM_ANT check result is clean. (Fill N/a if no MIMCAP inserted or no MIM related layers)"
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-14 --force

# Run individual tests
python IMP-12-0-0-14.py
