...
**Check ID:** IMP-12-0-0-23  
**Description:** Confirm set proper LVS bump text files (e.g: not include VDDG/VREF internal pin).  
...
item_desc = "Confirm set proper LVS bump text files (e.g: not include VDDG/VREF internal pin)."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-23 --force

# Run individual tests
python IMP-12-0-0-23.py
