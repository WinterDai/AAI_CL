...
**Check ID:** IMP-12-0-0-16  
**Description:** Confrim there is no issue for lvs.rep and extra pins in lvs.rep.cls even the results shows MATCH(check the Note)  
...
item_desc = "Confrim there is no issue for lvs.rep and extra pins in lvs.rep.cls even the results shows MATCH(check the Note)"
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-16 --force

# Run individual tests
python IMP-12-0-0-16.py
