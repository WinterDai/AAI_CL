...
**Check ID:** IMP-12-0-0-15  
**Description:** Confirm the LVS check result is match.  
...
item_desc = "Confirm the LVS check result is match."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-15 --force

# Run individual tests
python IMP-12-0-0-15.py
