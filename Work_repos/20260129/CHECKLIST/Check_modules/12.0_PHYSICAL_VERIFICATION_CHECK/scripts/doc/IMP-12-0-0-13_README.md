...
**Check ID:** IMP-12-0-0-13  
**Description:** Confirm the ANT check result is clean.  
...
item_desc = "Confirm the ANT check result is clean."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-13 --force

# Run individual tests
python IMP-12-0-0-13.py
