...
**Check ID:** IMP-12-0-0-22  
**Description:** Confirm all Warning message in PV log files can be waived.  
...
item_desc = "Confirm all Warning message in PV log files can be waived."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-22 --force

# Run individual tests
python IMP-12-0-0-22.py
