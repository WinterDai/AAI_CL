...
**Check ID:** IMP-12-0-0-29  
**Description:** Confirm all Warning message in ARC log files can be waived. (For BRCM project only, for others fill N/A)  
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-29 --force

# Run individual tests
python IMP-12-0-0-29.py
