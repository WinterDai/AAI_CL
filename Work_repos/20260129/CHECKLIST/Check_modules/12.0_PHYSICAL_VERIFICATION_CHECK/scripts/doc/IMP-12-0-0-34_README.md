...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-34 --force

# Run individual tests
python IMP-12-0-0-34.py
