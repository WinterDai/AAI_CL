...
**Check ID:** IMP-12-0-0-18  
**Description:** Confirm the ERC check result is clean.  
...
item_desc = "Confirm the ERC check result is clean."
...
python common/regression_testing/create_all_snapshots.py --modules 12.0_PHYSICAL_VERIFICATION_CHECK --checkers IMP-12-0-0-18 --force

# Run individual tests
python IMP-12-0-0-18.py
