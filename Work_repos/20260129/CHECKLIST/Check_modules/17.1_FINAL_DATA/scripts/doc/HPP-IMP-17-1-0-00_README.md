...
**Check ID:** HPP-IMP-17-1-0-00  
**Description:** If IP under DR3 review implements a register containing the revision/version of the IP, please confirm that this register contains the correct revision/version of the IP w.r.t this DR3 Review?  
...
item_desc = "If IP under DR3 review implements a register containing the revision/version of the IP, please confirm that this register contains the correct revision/version of the IP w.r.t this DR3 Review?"
...
python common/regression_testing/create_all_snapshots.py --modules 17.1_FINAL_DATA --checkers HPP-IMP-17-1-0-00 --force

# Run individual tests
python HPP-IMP-17-1-0-00.py
