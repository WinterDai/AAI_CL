...
**Check ID:** IMP-5-0-0-04  
**Description:** Confirm Jasper RTL Lint Summary report has no Error?  
...
item_desc = "Confirm Jasper RTL Lint Summary report has no Error?"
...
python common/regression_testing/create_all_snapshots.py --modules 5.0_SYNTHESIS_CHECK --checkers IMP-5-0-0-04 --force

# Run individual tests
python IMP-5-0-0-04.py
