...
**Check ID:** SRG-IMP-17-3-0-03  
**Description:** Is the Delivery Package contains Test Chip Description doc  
...
python common/regression_testing/create_all_snapshots.py --modules 17.3_FINAL_DATA --checkers SRG-IMP-17-3-0-03 --force

# Run individual tests
python SRG-IMP-17-3-0-03.py
