...
**Check ID:** SRG-IMP-17-3-0-05  
**Description:** Is the Delivery Package contains all the PV run sets (Only settings)  
...
python common/regression_testing/create_all_snapshots.py --modules 17.3_FINAL_DATA --checkers SRG-IMP-17-3-0-05 --force

# Run individual tests
python SRG-IMP-17-3-0-05.py
