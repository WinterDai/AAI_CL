...
**Check ID:** SRG-IMP-17-3-0-01  
**Description:** Is the Delivery Package contains Device List  
...
python common/regression_testing/create_all_snapshots.py --modules 17.3_FINAL_DATA --checkers SRG-IMP-17-3-0-01 --force

# Run individual tests
python SRG-IMP-17-3-0-01.py
