...
**Check ID:** SRG-IMP-17-3-0-04  
**Description:** Is the Delivery Package contains all the PV report files  
...
python common/regression_testing/create_all_snapshots.py --modules 17.3_FINAL_DATA --checkers SRG-IMP-17-3-0-04 --force

# Run individual tests
python SRG-IMP-17-3-0-04.py
