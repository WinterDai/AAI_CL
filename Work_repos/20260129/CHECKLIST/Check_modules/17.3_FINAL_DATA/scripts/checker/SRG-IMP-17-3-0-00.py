################################################################################
# Script Name: SRG-IMP-17-3-0-00.py
#
# Purpose:
#   Is the Delivery Package contains layer map file
#
# Logic:
...
class Check_SRG_17_3_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-17-3-0-00",
            item_desc="Is the Delivery Package contains layer map file"
        )
