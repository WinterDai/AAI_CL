################################################################################
# Script Name: SRG-IMP-17-3-0-05.py
#
# Purpose:
#   Is the Delivery Package contains all the PV run sets (Only settings)
#
# Logic:
...
class Check_SRG_17_3_0_05(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="17.3_FINAL_DATA",
            item_id="SRG-IMP-17-3-0-05",
            item_desc="Is the Delivery Package contains all the PV run sets (Only settings)"
        )
