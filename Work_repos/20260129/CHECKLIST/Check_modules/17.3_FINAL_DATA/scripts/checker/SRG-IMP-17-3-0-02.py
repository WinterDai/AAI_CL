################################################################################
# Script Name: SRG-IMP-17-3-0-02.py
#
# Purpose:
#   Is the Delivery Package contains IP vendor check list form
#
# Logic:
...
class Check_SRG_17_3_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-17-3-0-02",
            item_desc="Is the Delivery Package contains IP vendor check list form"
        )
