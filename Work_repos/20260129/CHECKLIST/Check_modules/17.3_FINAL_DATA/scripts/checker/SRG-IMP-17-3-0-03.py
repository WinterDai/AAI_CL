################################################################################
# Script Name: SRG-IMP-17-3-0-03.py
#
# Purpose:
#   Is the Delivery Package contains Test Chip Description doc
#
# Logic:
...
class Check_SRG_17_3_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-17-3-0-03",
            item_desc="Is the Delivery Package contains Test Chip Description doc"
        )
