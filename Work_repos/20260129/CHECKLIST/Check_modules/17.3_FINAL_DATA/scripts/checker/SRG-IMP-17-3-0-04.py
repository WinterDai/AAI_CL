################################################################################
# Script Name: SRG-IMP-17-3-0-04.py
#
# Purpose:
#   Is the Delivery Package contains all the PV report files
#
# Logic:
...
class Check_SRG_17_3_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-17-3-0-04",
            item_desc="Is the Delivery Package contains all the PV report files"
        )
