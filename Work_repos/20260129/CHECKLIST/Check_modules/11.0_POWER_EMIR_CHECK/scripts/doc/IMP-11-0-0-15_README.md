...
**Check ID:** IMP-11-0-0-15  
**Description:** List default EM temperature in design rule. (eg. 105C/110C)  
...
python common/regression_testing/create_all_snapshots.py --modules 11.0_POWER_EMIR_CHECK --checkers IMP-11-0-0-15 --force

# Run individual tests
python IMP-11-0-0-15.py
