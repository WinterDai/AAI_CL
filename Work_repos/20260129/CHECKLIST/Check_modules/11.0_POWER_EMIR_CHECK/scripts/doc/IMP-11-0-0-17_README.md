...
python common/regression_testing/create_all_snapshots.py --modules 11.0_POWER_EMIR_CHECK --checkers IMP-11-0-0-17 --force

# Run individual tests
python IMP-11-0-0-17.py
