...
**Check ID:** IMP-11-0-0-08  
**Description:** Confirm full PG connection information are included in def to run PA.  
...
python common/regression_testing/create_all_snapshots.py --modules 11.0_POWER_EMIR_CHECK --checkers IMP-11-0-0-08 --force

# Run individual tests
python IMP-11-0-0-08.py
