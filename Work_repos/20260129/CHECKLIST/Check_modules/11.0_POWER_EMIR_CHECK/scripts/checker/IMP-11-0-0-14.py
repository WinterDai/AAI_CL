################################################################################
# Script Name: IMP-11-0-0-14.py
#
# Purpose:
#   List default continous operation years in design rule. (eg: 10 years)
#
# Logic:
...
class Check_11_0_0_14(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-11-0-0-14",
            item_desc="List default continous operation years in design rule. (eg: 10 years)"
        )
