################################################################################
# Script Name: IMP-11-0-0-13.py
#
# Purpose:
#   Confirm dynamic power results matches the requirement.
#
# Logic:
...
class Check_11_0_0_13(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
