################################################################################
# Script Name: IMP-11-0-0-11.py
#
# Purpose:
#   Confirm the power number can meet the power target in addendum if addendum has the power spec.
#
# Logic:
...
class Check_11_0_0_11(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
