################################################################################
# Script Name: IMP-11-0-0-25.py
#
# Purpose:
#   Confirm use TSO to run power opt including leakage opt
#
# Logic:
...
class Check_11_0_0_25(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
