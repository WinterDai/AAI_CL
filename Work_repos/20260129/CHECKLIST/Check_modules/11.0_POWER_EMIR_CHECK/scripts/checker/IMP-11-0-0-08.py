################################################################################
# Script Name: IMP-11-0-0-08.py
#
# Purpose:
#   Confirm full PG connection information are included in def to run PA.
#
# Logic:
...
class Check_11_0_0_08(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-11-0-0-08",
            item_desc="Confirm full PG connection information are included in def to run PA."
        )
