################################################################################
# Script Name: IMP-11-0-0-24.py
#
# Purpose:
#   Confirm the VT ratio calculation excludes physical cells(Filler/DCAP/Tap etc).
#
# Logic:
...
class Check_11_0_0_24(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
