################################################################################
# Script Name: IMP-11-0-0-27.py
#
# Purpose:
#   Confirm adequate decaps were added to meet design requirements?
#
# Logic:
...
class Check_11_0_0_27(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-11-0-0-27",
            item_desc="Confirm adequate decaps were added to meet design requirements?"
        )
