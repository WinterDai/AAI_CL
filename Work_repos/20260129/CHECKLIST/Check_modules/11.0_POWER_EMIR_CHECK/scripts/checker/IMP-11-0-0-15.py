################################################################################
# Script Name: IMP-11-0-0-15.py
#
# Purpose:
#   List default EM temperature in design rule. (eg. 105C/110C)
#
# Logic:
...
class Check_11_0_0_15(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-11-0-0-15",
            item_desc="List default EM temperature in design rule. (eg. 105C/110C)"
        )
