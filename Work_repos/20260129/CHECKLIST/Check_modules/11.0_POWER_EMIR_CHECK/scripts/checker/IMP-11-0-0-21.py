################################################################################
# Script Name: IMP-11-0-0-21.py
#
# Purpose:
#   Confirm rush-current meet the requirement. (For non-PSO, please fill N/A)
#
# Logic:
...
class Check_11_0_0_21(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
