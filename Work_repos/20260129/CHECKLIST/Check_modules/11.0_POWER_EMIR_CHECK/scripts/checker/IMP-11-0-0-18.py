################################################################################
# Script Name: IMP-11-0-0-18.py
#
# Purpose:
#   Confirm signalEM analysis results matches the requirement.
#
# Logic:
...
class Check_11_0_0_18(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
