################################################################################
# Script Name: IMP-11-0-0-09.py
#
# Purpose:
#   Confirm Power pad locations correctly defined. Note: voltage sources need to be defined on the input side (VDDG) of power switches to all tool to calculate IR drop through power switch.
#
# Logic:
...
class Check_11_0_0_09(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
