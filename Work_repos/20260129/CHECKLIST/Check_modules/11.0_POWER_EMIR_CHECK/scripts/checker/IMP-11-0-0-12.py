################################################################################
# Script Name: IMP-11-0-0-12.py
#
# Purpose:
#   Confirm the power number between EW and NS is similiar if this program has both NS and EW orientations.(< 10% at least. fill N/A in case only one orientation)
#
# Logic:
...
class Check_11_0_0_12(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
