...
**Check ID:** SRG-IMP-11-3-0-00  
**Description:** Is SDC/TWF coverage more than 95% ?  
...
item_desc = "Is SDC/TWF coverage more than 95% ?"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-00 --force

# Run individual tests
python SRG-IMP-11-3-0-00.py
