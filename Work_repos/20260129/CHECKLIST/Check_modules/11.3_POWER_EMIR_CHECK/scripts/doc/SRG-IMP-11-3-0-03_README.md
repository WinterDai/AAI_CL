...
**Check ID:** SRG-IMP-11-3-0-03  
**Description:** Is the missing via check is clean  
...
item_desc = "Is the missing via check is clean"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-03 --force

# Run individual tests
python SRG-IMP-11-3-0-03.py
