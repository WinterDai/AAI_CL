...
**Check ID:** SRG-IMP-11-3-0-01  
**Description:** Is SPEF coverage 100% ?If not, mention reason in comments  
...
item_desc = "Is SPEF coverage 100% ?If not, mention reason in comments"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-01 --force

# Run individual tests
python SRG-IMP-11-3-0-01.py
