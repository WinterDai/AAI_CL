...
**Check ID:** SRG-IMP-11-3-0-05  
**Description:** Is resolution during dynamic simulation mentioned in comments ?  
...
item_desc = "Is resolution during dynamic simulation mentioned in comments ?"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-05 --force

# Run individual tests
python SRG-IMP-11-3-0-05.py
