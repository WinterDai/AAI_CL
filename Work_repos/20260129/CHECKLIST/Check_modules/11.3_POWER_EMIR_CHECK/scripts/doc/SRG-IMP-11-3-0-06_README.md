...
**Check ID:** SRG-IMP-11-3-0-06  
**Description:** Is VCD tag mentioned in the comments?  
...
item_desc = "Is VCD tag mentioned in the comments?"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-06 --force

# Run individual tests
python SRG-IMP-11-3-0-06.py
