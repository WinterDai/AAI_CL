...
**Check ID:** SRG-IMP-11-3-0-02  
**Description:** Is QRC tech file with proper corner and metal stack mentioned in comments?  
...
item_desc = "Is QRC tech file with proper corner and metal stack mentioned in comments?"
...
python common/regression_testing/create_all_snapshots.py --modules 11.3_POWER_EMIR_CHECK --checkers SRG-IMP-11-3-0-02 --force

# Run individual tests
python SRG-IMP-11-3-0-02.py
