################################################################################
# Script Name: SRG-IMP-11-3-0-02.py
#
# Purpose:
#   Is QRC tech file with proper corner and metal stack mentioned in comments?
#
# Logic:
...
class Check_SRG_11_3_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
