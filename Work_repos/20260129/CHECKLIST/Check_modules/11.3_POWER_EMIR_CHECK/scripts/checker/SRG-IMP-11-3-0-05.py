################################################################################
# Script Name: SRG-IMP-11-3-0-05.py
#
# Purpose:
#   Is resolution during dynamic simulation mentioned in comments ?
#
# Logic:
...
class Check_SRG_11_3_0_05(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
