################################################################################
# Script Name: SRG-IMP-11-3-0-06.py
#
# Purpose:
#   Is VCD tag mentioned in the comments?
#
# Logic:
...
class Check_SRG_11_3_0_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
