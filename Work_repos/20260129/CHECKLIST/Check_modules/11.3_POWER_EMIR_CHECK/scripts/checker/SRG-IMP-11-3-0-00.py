################################################################################
# Script Name: SRG-IMP-11-3-0-00.py
#
# Purpose:
#   Is SDC/TWF coverage more than 95% ?
#
# Logic:
...
class Check_SRG_11_3_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
