################################################################################
# Script Name: SRG-IMP-11-3-0-04.py
#
# Purpose:
#   Is simulation time mentioned in the comments?
#
# Logic:
...
class Check_SRG_11_3_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
