...
python common/regression_testing/create_all_snapshots.py --modules 9.0_RC_EXTRACTION_CHECK --checkers IMP-9-0-0-06 --force

# Run individual tests
python IMP-9-0-0-06.py
