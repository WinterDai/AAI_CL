...
**Check ID:** SRG-IMP-10-3-0-00  
**Description:** There should not be any clock cells in the data path  
...
python common/regression_testing/create_all_snapshots.py --modules 10.3_STA_DCD_CHECK --checkers SRG-IMP-10-3-0-00 --force

# Run individual tests
python SRG-IMP-10-3-0-00.py
