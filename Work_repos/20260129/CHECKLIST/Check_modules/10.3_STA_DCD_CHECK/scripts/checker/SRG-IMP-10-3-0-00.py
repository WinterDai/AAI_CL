################################################################################
# Script Name: SRG-IMP-10-3-0-00.py
#
# Purpose:
#   There should not be any clock cells in the data path
#
# Logic:
...
class Check_SRG_10_3_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-10-3-0-00",
            item_desc="There should not be any clock cells in the data path"
        )
