################################################################################
# Script Name: SRG-IMP-10-3-0-01.py
#
# Purpose:
#   All the clock definitions should be defined on the clock sources only
#
# Logic:
...
class Check_SRG_10_3_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="10.3_STA_DCD_CHECK",
            item_id="SRG-IMP-10-3-0-01",
            item_desc="All the clock definitions should be defined on the clock sources only"
        )
