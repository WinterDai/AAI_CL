...
**Check ID:** HBM-IMP-10-2-0-01  
**Description:** Setup uncertainty, OCV Parameters. Static IR 15mV based deltaV + 10C deltaT  
...
python common/regression_testing/create_all_snapshots.py --modules 10.2_STA_DCD_CHECK --checkers HBM-IMP-10-2-0-01 --force

# Run individual tests
python HBM-IMP-10-2-0-01.py
