...
**Check ID:** HBM-IMP-10-2-0-00  
**Description:** Conditions used to verify max clock frequency (e.g. wireload model, etc.). SPEF + 5% of clock period as setup uncertainty  
...
python common/regression_testing/create_all_snapshots.py --modules 10.2_STA_DCD_CHECK --checkers HBM-IMP-10-2-0-00 --force

# Run individual tests
python HBM-IMP-10-2-0-00.py
