...
**Check ID:** HBM-IMP-10-2-0-02  
**Description:** Hold uncertainty, OCV parameters Static IR 15mV based deltaV + 10C deltaT  
...
python common/regression_testing/create_all_snapshots.py --modules 10.2_STA_DCD_CHECK --checkers HBM-IMP-10-2-0-02 --force

# Run individual tests
python HBM-IMP-10-2-0-02.py
