...
**Check ID:** HBM-IMP-10-2-0-03  
**Description:** Were appropriate lifetime deratings defined for use in STA/HSTA analysis? (frequency or uncertainty deratings) describe in Comments section  
...
python common/regression_testing/create_all_snapshots.py --modules 10.2_STA_DCD_CHECK --checkers HBM-IMP-10-2-0-03 --force

# Run individual tests
python HBM-IMP-10-2-0-03.py
