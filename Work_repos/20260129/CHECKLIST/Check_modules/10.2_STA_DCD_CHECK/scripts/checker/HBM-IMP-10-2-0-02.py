################################################################################
# Script Name: HBM-IMP-10-2-0-02.py
#
# Purpose:
#   Hold uncertainty, OCV parameters Static IR 15mV based deltaV + 10C deltaT
#
# Logic:
...
class Check_HBM_10_2_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="HBM-IMP-10-2-0-02",
            item_desc="Hold uncertainty, OCV parameters Static IR 15mV based deltaV + 10C deltaT"
        )
