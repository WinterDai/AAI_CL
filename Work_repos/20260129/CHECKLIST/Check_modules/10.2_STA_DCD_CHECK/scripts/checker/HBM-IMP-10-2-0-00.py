################################################################################
# Script Name: HBM-IMP-10-2-0-00.py
#
# Purpose:
#   Conditions used to verify max clock frequency (e.g. wireload model, etc.). SPEF + 5% of clock period as setup uncertainty
#
# Logic:
...
class Check_HBM_10_2_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="HBM-IMP-10-2-0-00",
            item_desc="Conditions used to verify max clock frequency (e.g. wireload model, etc.). SPEF + 5% of clock period as setup uncertainty"
        )
