################################################################################
# Script Name: HBM-IMP-10-2-0-01.py
#
# Purpose:
#   Setup uncertainty, OCV Parameters. Static IR 15mV based deltaV + 10C deltaT
#
# Logic:
...
class Check_HBM_10_2_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="HBM-IMP-10-2-0-01",
            item_desc="Setup uncertainty, OCV Parameters. Static IR 15mV based deltaV + 10C deltaT"
        )
