################################################################################
# Script Name: HBM-IMP-10-2-0-03.py
#
# Purpose:
#   Were appropriate lifetime deratings defined for use in STA/HSTA analysis? (frequency or uncertainty deratings) describe in Comments section
#
# Logic:
...
class Check_HBM_10_2_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="10.2_STA_DCD_CHECK",
            item_id="HBM-IMP-10-2-0-03",
            item_desc="Were appropriate lifetime deratings defined for use in STA/HSTA analysis? (frequency or uncertainty deratings) describe in Comments section"
        )
