################################################################################
# Script Name: HBM-IMP-17-2-0-00.py
#
# Purpose:
#   Has the complete set of rule decks, LVS/DRC settings, and other setup requirements used to generate and signoff the final delivery been archived in case the runs must be replicated in the future?
#
# Logic:
...
class Check_HBM_17_2_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="17.2_FINAL_DATA",
            item_id="HBM-IMP-17-2-0-00",
            item_desc="Has the complete set of rule decks, LVS/DRC settings, and other setup requirements used to generate and signoff the final delivery been archived in case the runs must be replicated in the future?"
        )
