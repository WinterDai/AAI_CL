################################################################################
# Script Name: HBM-IMP-17-2-0-01.py
#
# Purpose:
#   Recommend performing a flush of the delivery flow with the customer to ensure all necessary files are delivered and the required database formats used. Has this been done?
#
# Logic:
...
class Check_HBM_17_2_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="HBM-IMP-17-2-0-01",
            item_desc="Recommend performing a flush of the delivery flow with the customer to ensure all necessary files are delivered and the required database formats used. Has this been done?"
        )
