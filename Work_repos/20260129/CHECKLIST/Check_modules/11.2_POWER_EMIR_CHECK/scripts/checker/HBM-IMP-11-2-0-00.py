################################################################################
# Script Name: HBM-IMP-11-2-0-00.py
#
# Purpose:
#   Was the final typical and worst case power computed using a simulation based VCD dump and provided to the design teams?
#
# Logic:
...
class Check_HBM_11_2_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="11.2_POWER_EMIR_CHECK",
            item_id="HBM-IMP-11-2-0-00",
            item_desc="Was the final typical and worst case power computed using a simulation based VCD dump and provided to the design teams?"
        )
