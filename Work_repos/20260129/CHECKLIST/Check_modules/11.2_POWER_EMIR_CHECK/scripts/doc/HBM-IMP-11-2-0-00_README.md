...
**Check ID:** HBM-IMP-11-2-0-00  
**Description:** Was the final typical and worst case power computed using a simulation based VCD dump and provided to the design teams?  
...
python common/regression_testing/create_all_snapshots.py --modules 11.2_POWER_EMIR_CHECK --checkers HBM-IMP-11-2-0-00 --force

# Run individual tests
python HBM-IMP-11-2-0-00.py
