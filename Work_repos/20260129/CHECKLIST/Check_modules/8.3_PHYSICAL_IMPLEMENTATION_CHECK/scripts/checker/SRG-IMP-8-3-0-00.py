################################################################################
# Script Name: SRG-IMP-8-3-0-00.py
#
# Purpose:
#   If shielding is required, is it done as per the customer/IP document inputs?
#
# Logic:
...
class Check_SRG_8_3_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="8.3_PHYSICAL_IMPLEMENTATION_CHECK",
            item_id="SRG-IMP-8-3-0-00",
            item_desc="If shielding is required, is it done as per the customer/IP document inputs?"
        )
