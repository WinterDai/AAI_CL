################################################################################
# Script Name: SRG-IMP-8-3-0-01.py
#
# Purpose:
#   Is the base XOR is clean?
#
# Logic:
...
class Check_SRG_8_3_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="SRG-IMP-8-3-0-01",
            item_desc="Is the base XOR is clean?"
        )
