...
python common/regression_testing/create_all_snapshots.py --modules 8.3_PHYSICAL_IMPLEMENTATION_CHECK --checkers SRG-IMP-8-3-0-01 --force

# Run individual tests
python SRG-IMP-8-3-0-01.py
