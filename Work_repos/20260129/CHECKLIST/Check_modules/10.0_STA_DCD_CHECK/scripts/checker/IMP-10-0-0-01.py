################################################################################
# Script Name: IMP-10-0-0-01.py
#
# Purpose:
#   Confirm there is no unresolved reference.
#
# Logic:
...
class Check_10_0_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-10-0-0-01",
            item_desc="Confirm there is no unresolved reference."
        )
    ...
    def _execute_type3(self) -> CheckResult:
        ...
        - parse_waive_items(): Parse waiver configuration
        - match_waiver_entry(): Match item against waivers
