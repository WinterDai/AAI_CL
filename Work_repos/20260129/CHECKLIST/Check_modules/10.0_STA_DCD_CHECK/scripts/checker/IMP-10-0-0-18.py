################################################################################
# Script Name: IMP-10-0-0-18.py
#
# Purpose:
#   Confirm the min_period check result is clean if library has min_period check.
#
# Logic:
...
class Check_10_0_0_18(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
