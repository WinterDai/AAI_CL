################################################################################
# Script Name: IMP-10-0-0-27.py
#
# Purpose:
#   Confirm final timing review was held and all open items closed (capture the review and waiver in JIRA ticket).
#
# Logic:
...
class Check_10_0_0_27(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
