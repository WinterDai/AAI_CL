################################################################################
# Script Name: IMP-10-0-0-19.py
#
# Purpose:
#   Confirm meet IP special DELAY/SKEW requirement if it have.
#
# Logic:
...
class Check_10_0_0_19(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
