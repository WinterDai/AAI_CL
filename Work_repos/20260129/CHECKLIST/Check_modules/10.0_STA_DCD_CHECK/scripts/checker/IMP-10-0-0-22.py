################################################################################
# Script Name: IMP-10-0-0-22.py
#
# Purpose:
#   Confirm timing/skew/drv/mpw/noise/ect results and log files are checked based on all signoff modes and all signoff corners.
#
# Logic:
...
class Check_10_0_0_22(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
