################################################################################
# Script Name: IMP-10-0-0-23.py
#
# Purpose:
#   Confirm the DCD check is clean if the design request DCD check on some special circuits.
#
# Logic:
...
class Check_10_0_0_23(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
