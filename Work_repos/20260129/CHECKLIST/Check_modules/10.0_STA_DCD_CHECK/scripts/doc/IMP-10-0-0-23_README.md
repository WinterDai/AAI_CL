...
**Check ID:** IMP-10-0-0-23  
**Description:** Confirm the DCD check is clean if the design request DCD check on some special circuits.  
...
item_desc = "Confirm the DCD check is clean if the design request DCD check on some special circuits."
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-23 --force

# Run individual tests
python IMP-10-0-0-23.py
