...
**Check ID:** IMP-10-0-0-19  
**Description:** Confirm meet IP special DELAY/SKEW requirement if it have.  
...
item_desc = "Confirm meet IP special DELAY/SKEW requirement if it have."
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-19 --force

# Run individual tests
python IMP-10-0-0-19.py
