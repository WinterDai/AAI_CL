...
**Check ID:** IMP-10-0-0-22  
**Description:** Confirm timing/skew/drv/mpw/noise/ect results and log files are checked based on all signoff modes and all signoff corners.  
...
item_desc = "Confirm timing/skew/drv/mpw/noise/ect results and log files are checked based on all signoff modes and all signoff corners."
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-22 --force

# Run individual tests
python IMP-10-0-0-22.py
