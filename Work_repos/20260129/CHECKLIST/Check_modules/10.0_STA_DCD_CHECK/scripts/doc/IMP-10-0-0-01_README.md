...
**Check ID:** IMP-10-0-0-01  
**Description:** Confirm there is no unresolved reference.  
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-01 --force

# Run individual tests
python IMP-10-0-0-01.py
