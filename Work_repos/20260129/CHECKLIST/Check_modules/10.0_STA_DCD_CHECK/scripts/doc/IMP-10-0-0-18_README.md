...
**Check ID:** IMP-10-0-0-18  
**Description:** Confirm the min_period check result is clean if library has min_period check.  
...
item_desc = "Confirm the min_period check result is clean if library has min_period check."
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-18 --force

# Run individual tests
python IMP-10-0-0-18.py
