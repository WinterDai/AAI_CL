...
**Check ID:** IMP-10-0-0-27  
**Description:** Confirm final timing review was held and all open items closed (capture the review and waiver in JIRA ticket).  
...
item_desc = "Confirm final timing review was held and all open items closed (capture the review and waiver in JIRA ticket)."
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-27 --force

# Run individual tests
python IMP-10-0-0-27.py
