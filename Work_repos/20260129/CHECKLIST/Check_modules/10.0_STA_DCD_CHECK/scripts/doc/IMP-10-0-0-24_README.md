...
**Check ID:** IMP-10-0-0-24  
**Description:** Any special timing requirement from the specifications that cannot be covered by SDC constraints are reported and reviewed? For example: DDR DQ/DQS skew check  
...
item_desc = "Any special timing requirement from the specifications that cannot be covered by SDC constraints are reported and reviewed? For example: DDR DQ/DQS skew check"
...
python common/regression_testing/create_all_snapshots.py --modules 10.0_STA_DCD_CHECK --checkers IMP-10-0-0-24 --force

# Run individual tests
python IMP-10-0-0-24.py
