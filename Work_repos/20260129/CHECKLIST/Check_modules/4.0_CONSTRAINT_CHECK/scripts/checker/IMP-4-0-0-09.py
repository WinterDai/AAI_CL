################################################################################
# Script Name: IMP-4-0-0-09.py
#
# Purpose:
#   Confirm SDC contains all necessary Functional, DFT and power modes (including voltage scaling mode/reduced voltage and/or performance)?
#
# Logic:
...
class Check_4_0_0_09(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            check_module="4.0_CONSTRAINT_CHECK",
            item_id="IMP-4-0-0-09",
            item_desc="Confirm SDC contains all necessary Functional, DFT and power modes (including voltage scaling mode/reduced voltage and/or performance)?"
        )
