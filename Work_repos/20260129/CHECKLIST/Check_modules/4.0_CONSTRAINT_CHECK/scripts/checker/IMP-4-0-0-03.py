################################################################################
# Script Name: IMP-4-0-0-03.py
#
# Purpose:
#   Confirm clock uncertainty constraints account for duty cycle distortion and duty cycle jitter for all clocks?
#
# Logic:
...
class Check_4_0_0_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-03",
            item_desc="Confirm clock uncertainty constraints account for duty cycle distortion and duty cycle jitter for all clocks?"
        )
