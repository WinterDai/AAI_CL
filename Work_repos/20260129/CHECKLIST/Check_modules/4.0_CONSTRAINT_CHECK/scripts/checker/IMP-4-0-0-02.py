################################################################################
# Script Name: IMP-4-0-0-02.py
#
# Purpose:
#   Confirm clock uncertainty constraints account for cycle-to-cycle jitter for all clocks?
#
# Logic:
...
class Check_4_0_0_02(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-02",
            item_desc="Confirm clock uncertainty constraints account for cycle-to-cycle jitter for all clocks?"
        )
