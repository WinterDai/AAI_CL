################################################################################
# Script Name: IMP-4-0-0-06.py
#
# Purpose:
#   Confirm all I/O constraints meet specified requirements?
#
# Logic:
...
class Check_4_0_0_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-06",
            item_desc="Confirm all I/O constraints meet specified requirements?"
        )
