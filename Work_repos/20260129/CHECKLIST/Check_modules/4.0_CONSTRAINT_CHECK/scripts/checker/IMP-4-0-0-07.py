################################################################################
# Script Name: IMP-4-0-0-07.py
#
# Purpose:
#   Confirm all unconstrained paths and IOs have been peer reviewed and approved?
#
# Logic:
...
class Check_4_0_0_07(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-07",
            item_desc="Confirm all unconstrained paths and IOs have been peer reviewed and approved?"
        )
