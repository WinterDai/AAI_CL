################################################################################
# Script Name: IMP-4-0-0-08.py
#
# Purpose:
#   Confirm all path exceptions (false paths, multicycle, max delay) have been peer reviewed and approved?
#
# Logic:
...
class Check_4_0_0_08(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-08",
            item_desc="Confirm all path exceptions (false paths, multicycle, max delay) have been peer reviewed and approved?"
        )
