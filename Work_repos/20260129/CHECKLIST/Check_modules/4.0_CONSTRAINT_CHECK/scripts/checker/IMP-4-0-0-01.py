################################################################################
# Script Name: IMP-4-0-0-01.py
#
# Purpose:
#   Confirm clock duty cycle constraints were reviewed for each clock and match or exceed specified requirements?
#
# Logic:
...
class Check_4_0_0_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-01",
            item_desc="Confirm clock duty cycle constraints were reviewed for each clock and match or exceed specified requirements?"
        )
