################################################################################
# Script Name: IMP-4-0-0-00.py
#
# Purpose:
#   Confirm clock constraints in the SDC match or exceed the specified requirements?
#
# Logic:
...
class Check_4_0_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-00",
            item_desc="Confirm clock constraints in the SDC match or exceed the specified requirements?"
        )
