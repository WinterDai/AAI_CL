################################################################################
# Script Name: IMP-4-0-0-10.py
#
# Purpose:
#   Confrim proper clock and data transition limit values were set?
#
# Logic:
...
class Check_4_0_0_10(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-10",
            item_desc="Confrim proper clock and data transition limit values were set?"
        )
