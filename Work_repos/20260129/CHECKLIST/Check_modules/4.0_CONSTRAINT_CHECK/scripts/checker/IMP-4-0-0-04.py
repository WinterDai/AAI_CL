################################################################################
# Script Name: IMP-4-0-0-04.py
#
# Purpose:
#   Confirm minimum uncertainty guidelines from foundry were followed and included in constraints?
#
# Logic:
...
class Check_4_0_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-4-0-0-04",
            item_desc="Confirm minimum uncertainty guidelines from foundry were followed and included in constraints?"
        )
