...
**Check ID:** IMP-4-0-0-05  
**Description:** Confirm clock uncertainties were reviewed for test modes (scan clocks coming from a different source, supported tester specs, etc.)?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-05 --force

# Run individual tests
python IMP-4-0-0-05.py
