...
**Check ID:** IMP-4-0-0-09  
**Description:** Confirm SDC contains all necessary Functional, DFT and power modes (including voltage scaling mode/reduced voltage and/or performance)?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-09 --force

# Run individual tests
python IMP-4-0-0-09.py
