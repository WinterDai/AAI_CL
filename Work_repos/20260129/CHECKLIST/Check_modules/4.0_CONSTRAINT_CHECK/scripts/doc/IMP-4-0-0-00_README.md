...
**Check ID:** IMP-4-0-0-00  
**Description:** Confirm clock constraints in the SDC match or exceed the specified requirements?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-00 --force

# Run individual tests
python IMP-4-0-0-00.py
