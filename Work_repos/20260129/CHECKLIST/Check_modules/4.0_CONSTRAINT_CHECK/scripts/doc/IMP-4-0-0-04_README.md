...
**Check ID:** IMP-4-0-0-04  
**Description:** Confirm minimum uncertainty guidelines from foundry were followed and included in constraints?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-04 --force

# Run individual tests
python IMP-4-0-0-04.py
