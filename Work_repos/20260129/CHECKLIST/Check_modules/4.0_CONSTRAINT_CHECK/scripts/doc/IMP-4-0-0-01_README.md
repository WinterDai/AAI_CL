...
**Check ID:** IMP-4-0-0-01  
**Description:** Confirm clock duty cycle constraints were reviewed for each clock and match or exceed specified requirements?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-01 --force

# Run individual tests
python IMP-4-0-0-01.py
