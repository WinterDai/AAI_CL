...
**Check ID:** IMP-4-0-0-10  
**Description:** Confrim proper clock and data transition limit values were set?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-10 --force

# Run individual tests
python IMP-4-0-0-10.py
