...
**Check ID:** IMP-4-0-0-06  
**Description:** Confirm all I/O constraints meet specified requirements?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-06 --force

# Run individual tests
python IMP-4-0-0-06.py
