...
**Check ID:** IMP-4-0-0-07  
**Description:** Confirm all unconstrained paths and IOs have been peer reviewed and approved?  
...
python common/regression_testing/create_all_snapshots.py --modules 4.0_CONSTRAINT_CHECK --checkers IMP-4-0-0-07 --force

# Run individual tests
python IMP-4-0-0-07.py
