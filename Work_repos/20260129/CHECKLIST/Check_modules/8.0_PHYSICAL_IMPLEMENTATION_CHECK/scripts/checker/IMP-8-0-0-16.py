################################################################################
# Script Name: IMP-8-0-0-16.py
#
# Purpose:
#   Confirm clock tree transitions meet requirement.
#
# Logic:
...
class Check_8_0_0_16(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
