################################################################################
# Script Name: IMP-8-0-1-01.py
#
# Purpose:
#   Confirm no BUMP rule violation or can be waived by the client or internal package team.
#
# Logic:
...
class Check_8_0_1_01(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-8-0-1-01",
            item_desc="Confirm no BUMP rule violation or can be waived by the client or internal package team."
        )
