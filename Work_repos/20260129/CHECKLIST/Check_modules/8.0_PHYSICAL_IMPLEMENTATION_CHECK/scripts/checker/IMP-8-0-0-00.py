################################################################################
# Script Name: IMP-8-0-0-00.py
#
# Purpose:
#   Confirm block orientation matches to addendum(NS/EW).
#
# Logic:
...
class Check_8_0_0_00(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
