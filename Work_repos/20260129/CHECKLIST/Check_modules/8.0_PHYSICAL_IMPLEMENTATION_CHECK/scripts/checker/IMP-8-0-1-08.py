################################################################################
# Script Name: IMP-8-0-1-08.py
#
# Purpose:
#   Confirm set "don't touch" is applied to all Analog Test Bus (ATB*) and any other analog signals which can't be buffered.
#
# Logic:
...
class Check_8_0_1_08(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
