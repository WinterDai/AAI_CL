################################################################################
# Script Name: IMP-8-0-0-11.py
#
# Purpose:
#   Confirm the design didn't use any don’t use cell of foundry and don’t_use cell list includes forbidden cells from IMP-1-0-0-02.
#
# Logic:
...
class Check_8_0_0_11(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
