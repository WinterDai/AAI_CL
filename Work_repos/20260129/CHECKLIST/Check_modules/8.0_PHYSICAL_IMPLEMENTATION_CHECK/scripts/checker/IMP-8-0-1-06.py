################################################################################
# Script Name: IMP-8-0-1-06.py
#
# Purpose:
#   Confirm that set "don't touch" is applied to all high voltage nets inside core power domain which can't be buffered with core cells (ex: VDD*GONE net in DDR PHY)
#
# Logic:
...
class Check_8_0_1_06(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
