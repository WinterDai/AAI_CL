################################################################################
# Script Name: IMP-8-0-1-04.py
#
# Purpose:
#   Confirm refer to Fab recommendation and requirement to insert ESD cell for core violtage .
#
# Logic:
...
class Check_8_0_1_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-8-0-1-04",
            item_desc="Confirm refer to Fab recommendation and requirement to insert ESD cell for core violtage ."
        )
