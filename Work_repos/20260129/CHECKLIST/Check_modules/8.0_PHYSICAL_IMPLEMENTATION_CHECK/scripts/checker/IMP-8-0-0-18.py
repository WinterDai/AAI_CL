################################################################################
# Script Name: IMP-8-0-0-18.py
#
# Purpose:
#   Confirm clock tree skew requirements are met.
#
# Logic:
...
class Check_8_0_0_18(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
