################################################################################
# Script Name: IMP-8-0-0-17.py
#
# Purpose:
#   Confirm clock tree latency requirements were met across all corners. Provide values in comments field.
#
# Logic:
...
class Check_8_0_0_17(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
