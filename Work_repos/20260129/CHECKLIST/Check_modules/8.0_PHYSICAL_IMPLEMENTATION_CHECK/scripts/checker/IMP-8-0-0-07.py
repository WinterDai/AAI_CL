################################################################################
# Script Name: IMP-8-0-0-07.py
#
# Purpose:
#   Confirm no Frontend(base layer) DRC violations.
#
# Logic:
...
class Check_8_0_0_07(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
