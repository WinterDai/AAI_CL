################################################################################
# Script Name: IMP-8-0-0-21.py
#
# Purpose:
#   If required, antenna diodes were added at the block/IP inputs.
#
# Logic:
...
class Check_8_0_0_21(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
