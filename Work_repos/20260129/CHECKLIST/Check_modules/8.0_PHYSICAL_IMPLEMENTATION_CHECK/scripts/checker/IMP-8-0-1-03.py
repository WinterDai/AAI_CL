################################################################################
# Script Name: IMP-8-0-1-03.py
#
# Purpose:
#   Confirm TCD(FETCD/BETCD) cells are inserted based on foundry requirement.
#
# Logic:
...
class Check_8_0_1_03(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            item_id="IMP-8-0-1-03",
            item_desc="Confirm TCD(FETCD/BETCD) cells are inserted based on foundry requirement."
        )
