################################################################################
# Script Name: IMP-8-0-1-07.py
#
# Purpose:
#   Confirm that proper NDR rule is applied to all high voltage nets inside core power domain to avoid HV spacing DRC violations (ex: VDD*GONE net in DDR PHY)
#
# Logic:
...
class Check_8_0_1_07(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
