################################################################################
# Script Name: IMP-8-0-0-19.py
#
# Purpose:
#   Confirm all multiflop synchronizer registers are the intended celltype and VT type upon which MTBF was calculated.
#
# Logic:
...
class Check_8_0_0_19(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
