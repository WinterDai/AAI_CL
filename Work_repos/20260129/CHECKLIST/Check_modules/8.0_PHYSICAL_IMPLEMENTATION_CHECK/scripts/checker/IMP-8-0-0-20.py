################################################################################
# Script Name: IMP-8-0-0-20.py
#
# Purpose:
#   Confirm that all the multiflop synchronizer registers are placed close together and their clock pin connected to the same leaf buffer/inverter of the clock tree?
#
# Logic:
...
class Check_8_0_0_20(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
