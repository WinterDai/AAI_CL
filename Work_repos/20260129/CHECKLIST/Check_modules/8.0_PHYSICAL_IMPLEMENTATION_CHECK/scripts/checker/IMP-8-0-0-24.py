################################################################################
# Script Name: IMP-8-0-0-24.py
#
# Purpose:
#   Confirm no assign in release netlist.
#
# Logic:
...
class Check_8_0_0_24(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
