################################################################################
# Script Name: IMP-8-0-0-22.py
#
# Purpose:
#   Confirm buffers were added close to each I/O and macro port.
#
# Logic:
...
class Check_8_0_0_22(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
