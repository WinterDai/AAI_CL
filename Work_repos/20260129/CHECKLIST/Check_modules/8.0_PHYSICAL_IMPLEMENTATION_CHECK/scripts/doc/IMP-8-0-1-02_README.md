...
**Check ID:** IMP-8-0-1-02  
**Description:** Confirm no RDL DRC violation.  
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-02 --force

# Run individual tests
python IMP-8-0-1-02.py
