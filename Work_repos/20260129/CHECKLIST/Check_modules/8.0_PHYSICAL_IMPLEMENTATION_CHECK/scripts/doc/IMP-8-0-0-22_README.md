...
**Check ID:** IMP-8-0-0-22  
**Description:** Confirm buffers were added close to each I/O and macro port.  
...
item_desc = "Confirm buffers were added close to each I/O and macro port."
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-0-22 --force

# Run individual tests
python IMP-8-0-0-22.py
