...
**Check ID:** IMP-8-0-0-11  
**Description:** Confirm the design didn't use any don’t use cell of foundry and don’t_use cell list includes forbidden cells from IMP-1-0-0-02.  
...
item_desc = "Confirm the design didn't use any don’t use cell of foundry and don’t_use cell list includes forbidden cells from IMP-1-0-0-02."
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-0-11 --force

# Run individual tests
python IMP-8-0-0-11.py
