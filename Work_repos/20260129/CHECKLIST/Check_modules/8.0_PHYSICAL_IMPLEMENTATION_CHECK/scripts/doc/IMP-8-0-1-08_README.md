...
**Check ID:** IMP-8-0-1-08  
**Description:** Confirm set "don't touch" is applied to all Analog Test Bus (ATB*) and any other analog signals which can't be buffered.  
...
item_desc = "Confirm set "don't touch" is applied to all Analog Test Bus (ATB*) and any other analog signals which can't be buffered."
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-08 --force

# Run individual tests
python IMP-8-0-1-08.py
