...
**Check ID:** IMP-8-0-1-04  
**Description:** Confirm refer to Fab recommendation and requirement to insert ESD cell for core violtage .  
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-04 --force

# Run individual tests
python IMP-8-0-1-04.py
