...
**Check ID:** IMP-8-0-1-01  
**Description:** Confirm no BUMP rule violation or can be waived by the client or internal package team.  
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-01 --force

# Run individual tests
python IMP-8-0-1-01.py
