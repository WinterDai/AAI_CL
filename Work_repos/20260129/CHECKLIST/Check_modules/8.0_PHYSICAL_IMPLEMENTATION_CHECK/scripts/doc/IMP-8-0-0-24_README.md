...
**Check ID:** IMP-8-0-0-24  
**Description:** Confirm no assign in release netlist.  
...
item_desc = "Confirm no assign in release netlist."
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-0-24 --force

# Run individual tests
python IMP-8-0-0-24.py
