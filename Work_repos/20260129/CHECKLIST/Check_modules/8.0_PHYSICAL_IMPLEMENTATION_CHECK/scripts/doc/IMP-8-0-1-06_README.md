...
**Check ID:** IMP-8-0-1-06  
**Description:** Confirm that set "don't touch" is applied to all high voltage nets inside core power domain which can't be buffered with core cells (ex: VDD*GONE net in DDR PHY)  
...
item_desc = "Confirm that set "don't touch" is applied to all high voltage nets inside core power domain which can't be buffered with core cells (ex: VDD*GONE net in DDR PHY)"
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-06 --force

# Run individual tests
python IMP-8-0-1-06.py
