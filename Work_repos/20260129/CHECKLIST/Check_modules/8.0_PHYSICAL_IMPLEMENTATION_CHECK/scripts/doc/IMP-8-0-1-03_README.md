...
**Check ID:** IMP-8-0-1-03  
**Description:** Confirm TCD(FETCD/BETCD) cells are inserted based on foundry requirement.  
...
python common/regression_testing/create_all_snapshots.py --modules 8.0_PHYSICAL_IMPLEMENTATION_CHECK --checkers IMP-8-0-1-03 --force

# Run individual tests
python IMP-8-0-1-03.py
