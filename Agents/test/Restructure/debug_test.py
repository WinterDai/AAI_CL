"""Debug test to see actual details from both checkers"""
import sys
...
# Load config
config_file = Path(__file__).parent / "TC01_Type1.yaml"
...
print("="*70)
print("GOLDEN CHECKER - TC01 Type1")
print("="*70)
...
print("\n" + "="*70)
print("CODEGEN AGGRESSIVE CHECKER - TC01 Type1")
print("="*70)
