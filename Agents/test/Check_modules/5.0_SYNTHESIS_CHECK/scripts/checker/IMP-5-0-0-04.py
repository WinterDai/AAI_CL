################################################################################
# Script Name: IMP-5-0-0-04.py
#
# Purpose:
#   Confirm Jasper RTL Lint Summary report has no Error?
#
# Logic:
...
class Check_5_0_0_04(InputFileParserMixin, OutputBuilderMixin, WaiverHandlerMixin, BaseChecker):
    """
