# ⚙️ Agent B (Logic Developer) - Prompt Input

**Item:** IMP-10-0-0-00  
**Iteration:** 0  
**Timestamp:** 2026-01-28 14:06:36
**Total Length:** 72,113 characters
...
|---------|------|
| Role | 188 chars |
| The 10.2 Hard Constraints (NON-NEGOTIABL | 0 chars |
| Atom B: validate_logic | 1,220 chars |
| Atom C: check_existence | 230 chars |
| Gate 2 Test Vectors (YOUR CODE MUST PASS | 697 chars |
| YAML Field Semantics Reference | 54 chars |
| Checker Type System (4 Types) | 491 chars |
| requirements.value Semantics | 117 chars |
| requirements.pattern_items Format | 285 chars |
| waivers.value Semantics | 163 chars |
| waivers.waive_items Behavior | 144 chars |
| CRITICAL: Zero Hardcoding Policy | 211 chars |
| Task 1: Mechanism (Python Code) | 67 chars |
| Task 2: Policy (YAML Configuration) | 152 chars |
| Output Format | 329 chars |
| ItemSpec Content | 28,410 chars |
| Agent A Code (extract_context) | 11,861 chars |
| Check Logic from ItemSpec | 26,894 chars |
