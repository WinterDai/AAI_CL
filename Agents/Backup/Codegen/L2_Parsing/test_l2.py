...
class TestOrchestrateParsing:
    ...
    def test_basic_parsing(self):
        # Mock Atom A
        def mock_atom_a(text):
            return [
                {'value': 'item1', 'line_number': 10, 'matched_content': 'content1', 'parsed_fields': {}},
                {'value': 'item2', 'line_number': 20, 'matched_content': 'content2', 'parsed_fields': {}}
            ]
    ...
    def test_indirect_reference_recursion(self):
        ...
        def mock_atom_a(text):
            ...
            if call_count['count'] == 1:
                ...
                # Second file
                return [
                    {'value': 'indirect', 'line_number': 1, 'matched_content': 'indirect', 'parsed_fields': {}}
                ]
        ...
        def mock_atom_a(text):
            ...
            return [
                {'value': 'item', 'line_number': 1, 'matched_content': 'content',
                 'parsed_fields': {'indirect_reference': 'next.rpt'}}
            ]
    ...
    def test_loop_detection(self):
        def mock_atom_a(text):
            ...
            return [
                {'value': 'item', 'line_number': 1, 'matched_content': 'content',
                 'parsed_fields': {'indirect_reference': '/abs/root.rpt'}}  # Loop back
            ]
    ...
    def test_searched_files_dedup_and_sort(self):
        def mock_atom_a(text):
            return [
                {'value': 'item', 'line_number': 1, 'matched_content': 'content', 'parsed_fields': {}}
            ]
